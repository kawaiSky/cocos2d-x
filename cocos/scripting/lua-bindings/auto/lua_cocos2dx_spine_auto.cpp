...
int lua_cocos2dx_spine_SkeletonRenderer_getNodeForSlot(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "sp.SkeletonRenderer:getNodeForSlot"); arg0 = arg0_tmp.c_str();
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonRenderer_getNodeForSlot'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonRenderer:getNodeForSlot",argc, 1);
    return 0;

...
int lua_cocos2dx_ui_Widget_setPixDataPath(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Widget* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Widget_setPixDataPath'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccui.Widget:setPixDataPath");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Widget_setPixDataPath'", nullptr);
            return 0;
        }
        cobj->setPixDataPath(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Widget:setPixDataPath",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Widget_setPixDataPath'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_Widget_getPixelColor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Widget* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Widget_getPixelColor'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_point(tolua_S, 3, &arg1, "ccui.Widget:getPixelColor");

        ok &= luaval_to_boolean(tolua_S, 4,&arg2, "ccui.Widget:getPixelColor");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Widget_getPixelColor'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Widget:getPixelColor",argc, 3);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Widget_getPixelColor'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_Widget(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Widget");
        ...
        tolua_function(tolua_S,"setPixDataPath",lua_cocos2dx_ui_Widget_setPixDataPath);
        ...
        tolua_function(tolua_S,"getPixelColor",lua_cocos2dx_ui_Widget_getPixelColor);
